...
public class SimpleDnaStrand implements DnaStrand {
	...
	/**
	 * Create a strand representing dnaSequence. No error checking is done to see if
	 * s represents valid genomic/DNA data.
	 * 
	 * @param dnaSequence
	...
	public DnaStrand cutSplice(String enzyme, String splicee) {
		...
		/*
		 * The next line is very syntax-dense. .indexOf looks for the first index at
		 * which enzyme occurs, starting at pos. Saying pos = ... assigns the result of
		 * that operation to the pos variable; the value of pos is then compared against
		 * zero.
		 * 
	...
	/**
	 * Initialize this strand so that it represents the value of source. No error
