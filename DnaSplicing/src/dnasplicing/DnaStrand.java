...
public interface DnaStrand {
	 ...
	 * incremented. If this DnaStrand is empty, append() should just do the same
	 * thing as the constructor. In this special case, appendCount is not
	 * incremented.
	 * 
	 * @param dnaSequence
	 ...
	 * 
	 * <b>NOTE</b>: This method will only be called when the linke list has just one
	 * node, and it will only be called once for a DnaStrand. This means that you do
	 * not need to worry about searching for enzyme matches across node boundaries.
	 * 
	 * @param enzyme
